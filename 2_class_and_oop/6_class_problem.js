...
const ive = new IdolGroup('ive', iveMembers.map(member => new FemaleIdol(member.name, member.year)));
console.log(ive);
const bts = new IdolGroup('bts', btsMembers.map(member => new MaleIdol(member.name, member.year)));
console.log(bts);
const country = new Country('korea', [ive, bts]);
